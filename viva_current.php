...
<li style="font-family:Book Antiqua ; font-size: 15px"><a href="examination.php">Examination</a></li>
 ...
 <div id="make_div" align="center" style="color: white;">
    ...
    <?php 
    $sql="SELECT * FROM viva_take NATURAL JOIN viva_details NATURAL JOIN viva_ques WHERE viva_take.viva_status=1;";
    ...
    <h4>Question ID: <?php echo $row["question_id"];echo"<br>"; ?> </h4>
